...
export class ChangeApproverComponent implements OnInit {
  ...
  getApprover(){
    debugger;
    const token =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..MiWjTR-l5omP1A7uJcjMN56SKXAax3pAIFkjI2tZaos';
  const headers = new HttpHeaders().set('Authorization', 'Bearer ' + token);
